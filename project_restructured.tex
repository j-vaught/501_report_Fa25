...
\hline\hline
\textbf{Surface} & \textbf{FFT} & \textbf{FD-Dirichlet} & \textbf{DCT-Neumann} & \textbf{Best} \\
\hline
Gaussian   & 0.0425 & \textbf{0.0261} & 0.0424 & Dirichlet \\
Sphere     & 0.1328 & \textbf{0.1322} & 0.1327 & Dirichlet \\
Ellipsoid  & 0.1019 & \textbf{0.1013} & 0.1018 & Dirichlet \\
Cone       & 0.0728 & \textbf{0.0725} & 0.0728 & Dirichlet \\
Cube       & 0.0449 & \textbf{0.0447} & 0.0449 & Dirichlet \\
Saddle     & 0.0298 & \textbf{0.0212} & 0.0297 & Dirichlet \\
Peaks      & 0.0545 & \textbf{0.0447} & 0.0543 & Dirichlet \\
Sinusoid   & \textbf{0.0266} & 0.0272 & 0.0267 & FFT \\
\hline\hline
\end{tabular}
\caption{RMSE comparison across all surfaces and solvers. Bold indicates lowest RMSE for each surface.}
\label{tab:solver_comparison_full}
\end{table}

\subsubsection{Key Observations}

The FD-Dirichlet solver dominates for most surfaces, achieving the lowest RMSE for 7 out of 8 test cases. This advantage stems from pinning boundary heights to zero, which is well-suited for surfaces that naturally decay at the edges of the domain. The Dirichlet boundary condition effectively eliminates edge artifacts that plague the FFT solver.

The only exception is the sinusoid surface, where FFT outperforms other solvers. This is expected: the sinusoid is inherently periodic, perfectly matching FFT's implicit periodic boundary conditions. For genuinely periodic data, FFT remains the optimal choice.

DCT-Neumann, while rarely the best, consistently performs within 1\% of Dirichlet for all surfaces. It provides a good balance when zero-flux boundary conditions are physically appropriate---for instance, when surfaces extend beyond the image frame with unknown edge heights.

Surfaces with sharp edges present challenges for all solvers. The cone and cube show higher RMSE overall, regardless of solver choice. This reflects a fundamental limitation of gradient-based methods: discontinuities in the gradient field cannot be perfectly integrated.
...
\includegraphics[width=\linewidth]{python_code/output/figures/gaussian/fd_dirichlet/3d_true.png}
\caption{True 3D}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/gaussian/fd_dirichlet/3d_est.png}
\caption{Reconstruction}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/gaussian/fd_dirichlet/depth_true.png}
\caption{Ground-truth depth}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/gaussian/fd_dirichlet/depth_est.png}
\caption{Recovered depth}
\end{subfigure}

\bigskip
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/gaussian/fd_dirichlet/error_map.png}
\caption{Depth error}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/gaussian/fd_dirichlet/profile.png}
\caption{Center-line profile}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/gaussian/fd_dirichlet/histogram.png}
\caption{Error histogram}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/gaussian/fd_dirichlet/normals_est.png}
\caption{Estimated normals}
\end{subfigure}
\caption{Gaussian surface reconstruction using FD-Dirichlet solver (RMSE = 0.0261). The smooth radially symmetric bump shows excellent reconstruction with errors concentrated at domain boundaries.}
...
\centering
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sphere/fd_dirichlet/3d_true.png}
\caption{True 3D}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sphere/fd_dirichlet/3d_est.png}
\caption{Reconstruction}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sphere/fd_dirichlet/depth_true.png}
\caption{Ground-truth depth}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sphere/fd_dirichlet/depth_est.png}
\caption{Recovered depth}
\end{subfigure}

\bigskip
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sphere/fd_dirichlet/error_map.png}
\caption{Depth error}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sphere/fd_dirichlet/profile.png}
\caption{Center-line profile}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sphere/fd_dirichlet/histogram.png}
\caption{Error histogram}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sphere/fd_dirichlet/normals_est.png}
\caption{Estimated normals}
\end{subfigure}
\caption{Sphere surface reconstruction using FD-Dirichlet solver (RMSE = 0.1322). Higher RMSE reflects difficulty with steep edge gradients where the surface curves away from the viewer.}
...
\centering
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/ellipsoid/fd_dirichlet/3d_true.png}
\caption{True 3D}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/ellipsoid/fd_dirichlet/3d_est.png}
\caption{Reconstruction}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/ellipsoid/fd_dirichlet/depth_true.png}
\caption{Ground-truth depth}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/ellipsoid/fd_dirichlet/depth_est.png}
\caption{Recovered depth}
\end{subfigure}

\bigskip
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/ellipsoid/fd_dirichlet/error_map.png}
\caption{Depth error}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/ellipsoid/fd_dirichlet/profile.png}
\caption{Center-line profile}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/ellipsoid/fd_dirichlet/histogram.png}
\caption{Error histogram}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/ellipsoid/fd_dirichlet/normals_est.png}
\caption{Estimated normals}
\end{subfigure}
\caption{Ellipsoid surface reconstruction using FD-Dirichlet solver (RMSE = 0.1013). Errors concentrate at high-curvature regions near the ellipsoid's extended axis.}
...
\centering
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cone/fd_dirichlet/3d_true.png}
\caption{True 3D}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cone/fd_dirichlet/3d_est.png}
\caption{Reconstruction}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cone/fd_dirichlet/depth_true.png}
\caption{Ground-truth depth}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cone/fd_dirichlet/depth_est.png}
\caption{Recovered depth}
\end{subfigure}

\bigskip
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cone/fd_dirichlet/error_map.png}
\caption{Depth error}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cone/fd_dirichlet/profile.png}
\caption{Center-line profile}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cone/fd_dirichlet/histogram.png}
\caption{Error histogram}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cone/fd_dirichlet/normals_est.png}
\caption{Estimated normals}
\end{subfigure}
\caption{Cone surface reconstruction using FD-Dirichlet solver (RMSE = 0.0725). Errors concentrate at the apex singularity where the gradient is undefined.}
...
\centering
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cube/fd_dirichlet/3d_true.png}
\caption{True 3D}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cube/fd_dirichlet/3d_est.png}
\caption{Reconstruction}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cube/fd_dirichlet/depth_true.png}
\caption{Ground-truth depth}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cube/fd_dirichlet/depth_est.png}
\caption{Recovered depth}
\end{subfigure}

\bigskip
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cube/fd_dirichlet/error_map.png}
\caption{Depth error}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cube/fd_dirichlet/profile.png}
\caption{Center-line profile}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cube/fd_dirichlet/histogram.png}
\caption{Error histogram}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/cube/fd_dirichlet/normals_est.png}
\caption{Estimated normals}
\end{subfigure}
\caption{Cube surface reconstruction using FD-Dirichlet solver (RMSE = 0.0447). Sharp right-angle edges cause ringing artifacts where the gradient is undefined.}
...
\centering
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/saddle/fd_dirichlet/3d_true.png}
\caption{True 3D}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/saddle/fd_dirichlet/3d_est.png}
\caption{Reconstruction}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/saddle/fd_dirichlet/depth_true.png}
\caption{Ground-truth depth}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/saddle/fd_dirichlet/depth_est.png}
\caption{Recovered depth}
\end{subfigure}

\bigskip
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/saddle/fd_dirichlet/error_map.png}
\caption{Depth error}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/saddle/fd_dirichlet/profile.png}
\caption{Center-line profile}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/saddle/fd_dirichlet/histogram.png}
\caption{Error histogram}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/saddle/fd_dirichlet/normals_est.png}
\caption{Estimated normals}
\end{subfigure}
\caption{Saddle surface reconstruction using FD-Dirichlet solver (RMSE = 0.0212), one of the best results overall. The mixed positive/negative curvature is recovered accurately.}
...
\centering
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sinusoid/fft/3d_true.png}
\caption{True 3D}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sinusoid/fft/3d_est.png}
\caption{Reconstruction}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sinusoid/fft/depth_true.png}
\caption{Ground-truth depth}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sinusoid/fft/depth_est.png}
\caption{Recovered depth}
\end{subfigure}

\bigskip
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sinusoid/fft/error_map.png}
\caption{Depth error}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sinusoid/fft/profile.png}
\caption{Center-line profile}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sinusoid/fft/histogram.png}
\caption{Error histogram}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/sinusoid/fft/normals_est.png}
\caption{Estimated normals}
\end{subfigure}
\caption{Sinusoid surface reconstruction using FFT solver (RMSE = 0.0266). This is the only surface where FFT outperforms other solvers, validating that periodic boundary conditions are optimal for genuinely periodic data.}
...
\centering
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/peaks/fd_dirichlet/3d_true.png}
\caption{True 3D}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/peaks/fd_dirichlet/3d_est.png}
\caption{Reconstruction}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/peaks/fd_dirichlet/depth_true.png}
\caption{Ground-truth depth}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/peaks/fd_dirichlet/depth_est.png}
\caption{Recovered depth}
\end{subfigure}

\bigskip
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/peaks/fd_dirichlet/error_map.png}
\caption{Depth error}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/peaks/fd_dirichlet/profile.png}
\caption{Center-line profile}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/peaks/fd_dirichlet/histogram.png}
\caption{Error histogram}
\end{subfigure}
\begin{subfigure}[b]{0.23\textwidth}
\includegraphics[width=\linewidth]{python_code/output/figures/peaks/fd_dirichlet/normals_est.png}
\caption{Estimated normals}
\end{subfigure}
\caption{MATLAB Peaks surface reconstruction using FD-Dirichlet solver (RMSE = 0.0447). The complex multi-modal surface with multiple Gaussian-like bumps is recovered accurately.}
...
\begin{minipage}{0.32\textwidth}
\centering
\includegraphics[width=\textwidth]{python_code/output/figures/gaussian/fd_dirichlet/depth_est.png}
